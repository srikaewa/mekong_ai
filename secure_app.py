...
if __name__ == '__main__':
    ...
    app.add_app("Drought Data Layers", icon="🗺", app=apps.DroughtDataLayers(title="Drought Disaster Import Layers"))
    app.add_app("Drought Import Data", icon="💾", app=apps.DroughtImportData(title="Drought Disaster Import Data"))
    app.add_app("Drought - AI Trainer", icon="🧠", app=apps.DroughtAIDashboard(title="Drought Disaster - AI Trainer"))

    app.add_app("Flood Data Layers", icon="🗺", app=apps.FloodDataLayers(title="Flood Disaster Import Layers"))
    app.add_app("Flood Import Data", icon="💾", app=apps.FloodImportData(title="Flood Disaster Import Data"))
    app.add_app("Flood - AI Trainer", icon="🧠", app=apps.FloodAIDashboard(title="Flood Disaster - AI Trainer"), logout_label="LOGGGGOUTT")
    ...
    if user_access_level > 0:
        complex_nav = {
            ...
            'Drought - Natural Disaster': ['Drought Data Layers', 'Drought Import Data'],
            'Flood - Natural Disaster': ['Flood Data Layers', 'Flood Import Data'],
            'AI Backend': ['Rice Pest - AI Trainer', 'Rice Blast - AI Trainer', 'Drought - AI Trainer', 'Flood - AI Trainer'],
        ...
        complex_nav = {
            'Home': ['Home'],
            'Rice Pest': ['Rice Pest Data Layers'],
            'Rice Blast': ['Rice Blast Data Layers'],
            'Drought - Natural Disaster': ['Drought Data Layers'],
            'Flood - Natural Disaster': ['Flood Data Layers'],
            #'AI Backend': ['Rice Pest - AI Trainer', 'Rice Blast - AI Trainer', 'Drought - AI Trainer', 'Flood - AI Trainer'],
            #'Loader Playground': ['Loader Playground'],
            #'Intro 🏆': ['Cheat Sheet',"Solar Mach"],
